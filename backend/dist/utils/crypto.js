 ...
 */
export async function signToken(payload, privateKeyHex) {
 ...
 */
export async function verifyToken(token, privateKeyHex) {
    try {
 ...
 */
export function generateDevPrivateKey() {
