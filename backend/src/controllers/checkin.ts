 ...
 */
export async function reportParticipant(req: Request, res: Response, next: NextFunction) {
  try {
    const { id } = req.params;
 ...
 */
export async function bulkReportStaff(req: Request, res: Response, next: NextFunction) {
  try {
