...
const FAQS = [
  ...
  { q: "Is it free to participate?", a: "Yes! Singularity is completely free to enter. There are no registration fees whatsoever." },
  ...
  { q: "Will food and accommodation be provided?", a: "Yes! All registered on-site participants get meals and refreshments throughout the 24-hour event. Accommodation details will be shared post-registration." },
