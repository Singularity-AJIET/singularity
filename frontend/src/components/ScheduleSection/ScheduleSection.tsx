...
const SCHEDULE = [
  {
    ...
    events: [
      ...
      { time: "9:30 AM – 10:00 AM", title: "Inauguration Ceremony", color: "#ff2a6d", label: "CEREMONY", desc: [<>Welcome Address, Chief Guest Address, Hackathon Brief, Rules & <strong className="text-lime">Problem Statement Selection</strong></>] },
      { time: "10:00 AM", title: "Official Hackathon Begins", color: "#c8f135", label: "HACK", desc: ["Coding officially begins"] },
      { time: "10:00 AM – 1:00 PM", title: "Development Continues", color: "#c8f135", label: "HACK", desc: ["Focus on core functionalities"] },
      { time: "1:00 PM", title: "Lunch Starts", color: "#ff7b00", label: "SOCIAL", desc: ["Lunch and informal networking"] },
      { time: "2:00 PM – 4:00 PM", title: "Development & Mentor Interactions", color: "#a78bfa", label: "MENTOR", desc: ["Technical mentorship & guidance"] },
      { time: "4:00 PM – 5:00 PM", title: "Phase 1 Evaluation", color: "#05d550", label: "JUDGING", desc: ["Progress Check by Judges & Mentors"] },
      { time: "5:00 PM", title: "Coffee & Snacks Distribution", color: "#38bdf8", label: "SOCIAL", desc: ["Evening refreshments"] },
      { time: "5:00 PM – 8:00 PM", title: "Development Continues", color: "#c8f135", label: "HACK", desc: ["Working on implementation feedback"] },
      { time: "8:00 PM", title: "Dinner Starts", color: "#888580", label: "SOCIAL", desc: ["Dinner and refreshment session"] },
      { time: "9:00 PM – 10:00 PM", title: "Phase 2 Evaluation", color: "#ff2a6d", label: "JUDGING", desc: ["Prototype Review & Feedback"] },
      { time: "10:00 PM – 1:00 AM", title: "Development & Mentor Support", color: "#a78bfa", label: "MENTOR", desc: ["Late night hacking & support"] },
    ],
  },
  {
    day: "Day 2",
    ...
    events: [
      ...
      { time: "7:30 AM", title: "Breakfast Starts", color: "#ff7b00", label: "SOCIAL", desc: ["Morning refreshment & networking"] },
      { time: "8:30 AM – 10:00 AM", title: "Final Development", color: "#c8f135", label: "HACK", desc: ["Testing & Project Submission"] },
      { time: "10:00 AM", title: "Hackathon Ends", color: "#ff2a6d", label: "DEADLINE", desc: ["Code Freeze & Final Submission"] },
      { time: "10:00 AM – 11:45 AM", title: "Final Evaluation", color: "#00d2ff", label: "JUDGING", desc: ["All teams demonstrate their completed projects to the judges"] },
      { time: "11:45 AM – 12:00 PM", title: "Overall Calculation", color: "#a78bfa", label: "LOGISTICS", desc: ["Calculation of final scores"] },
      { time: "12:00 PM – 1:00 PM", title: "Valedictory Function", color: "#ffb830", label: "CEREMONY", desc: ["Winner Announcement & Prize Distribution"] },
      { time: "1:00 PM", title: "Lunch Starts", color: "#ff7b00", label: "SOCIAL", desc: ["Lunch for participants, mentors, judges"] },
    ],
  }
];
