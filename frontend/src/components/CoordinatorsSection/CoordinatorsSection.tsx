...
const getNameFontSize = (name: string): string | undefined => {
  ...
  if (len > 16) return "clamp(2.0rem, 3.4vw, 3.2rem)";
  if (len > 14) return "clamp(2.2rem, 3.8vw, 3.6rem)";
...
const TEAM_COORDINATORS: Coordinator[] = [
  ...
  { name: "Daksh", imgPosition: "center 15%", role: "Design Lead", seed: "Daksh", photo: "/team/Daksh.webp", color: "#00b4d8", github: "https://github.com/Beasteroid72", instagram: "https://www.instagram.com/duckymangalsingh/" },
];
